...
#SBATCH --mem=4GB
#SBATCH --job-name=APS158collectgenes
...
##INPUTS
jobdir=/scratch/aps376/recombo/APS158collectgenes
#list=/scratch/aps376/recombo/APS158_fetchSRA/APS156_full_SRA_list
WRKD=/scratch/aps376/recombo/APS158_spneumoniae
OUTDIR=/scratch/aps376/recombo/APS158_SP_Archive/SP_MASTER_OUT
list=${WRKD}/APS156_completepiles
...
echo "let's rock"
CollectPangenomeAlignments ${list} ${ref} ${WRKD} ${OUTDIR}/MSA_SP_PANGENOME_MASTER --progress
