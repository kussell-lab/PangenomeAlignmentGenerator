...
##INPUTS
jobdir=/scratch/aps376/recombo/APS158_fetchSRA
list=${jobdir}/APS156_full_SRA_list
outdir=/scratch/aps376/recombo/APS158_spneumoniae
...
echo "let's rock"
cd ${outdir}
parallel singularity exec /home/aps376/sra-tools.sif prefetch :::: ${list}
