...
#SBATCH --mem=4GB
#SBATCH --job-name=APS161prokka
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS161prokka_slurm%j.out


##INPUTS
jobdir=/scratch/aps376/recombo/APS161prokka
#list=/scratch/aps376/recombo/APS158_fetchSRA/APS156_full_SRA_list
WRKD=/scratch/aps376/recombo/APS161_SA_Archive
OUTDIR=${WRKD}/prokka
