...
#SBATCH --time=1:00:00
#SBATCH --mem=4GB
#SBATCH --job-name=APS160genomelist
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS160genomelist_slurm%j.out
...
cutoff=99
OUTDIR=/scratch/aps376/recombo/APS160_SP_Archive/corethreshold99
...
echo "let's rock"
python3 APS160makestrainlist.py
