...
#SBATCH --time=8:00:00
#SBATCH --mem=4GB
#SBATCH --job-name=APS159collectgenes
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS158collectgenes_slurm%j.out


##INPUTS
jobdir=/scratch/aps376/recombo/APS159collectgenes
#list=/scratch/aps376/recombo/APS158_fetchSRA/APS156_full_SRA_list
WRKD=/scratch/aps376/recombo/APS159_ngonorrhoeae
OUTDIR=/scratch/aps376/recombo/APS159_NG_Archive/NG_MASTER_OUT
list=${WRKD}/APS159_completepiles
...
echo "let's rock"
CollectPangenomeAlignments ${list} ${ref} ${WRKD} ${OUTDIR}/MSA_NG_PANGENOME_MASTER --progress
