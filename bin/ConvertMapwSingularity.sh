...
function map2reference {
    ...
    singularity exec /home/aps376/sra-tools.sif prefetch ${READ}
    singularity exec /home/aps376/sra-tools.sif fastq-dump -O ${WORKING_DIR} --split-3 ${sra_file}
    singularity exec /home/aps376/smalt.sif smalt map -n 1 ${REFERENCE} ${WORKING_DIR}/${READ}_1.fastq ${WORKING_DIR}/${READ}_2.fastq | \
...
working_dir=$2
reference=$3
singularity exec /home/aps376/smalt.sif smalt index ${reference} ${reference}
